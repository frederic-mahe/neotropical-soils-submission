...
- missing coordinates for T185-T186 (spelled `T185-186` in the EukBank table), could be the case also in our samples (check fastq files)!
- same thing for T199_T200
- same thing for L137_L13
